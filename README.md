...
| ピンポイント天気で芝しごと | 予報 | 同一サイト `/portal/spray/` へリンク。時間毎の芝管理作業アドバイス（v1.1.3） |
...
### 病害画像診断AI（`/portal/diagnosis/`） v1.1.3（2026-09）

- リード文の下に **【公式解説】** リンクを追加（【公式解説】【新しい解説】【▶解説動画】の並び）

### 病害画像診断AI（`/portal/diagnosis/`） v1.1.2（2026-09）

- リード文の下に **🆕 新しい解説**（ブログ）・ **▶ 解説動画**（YouTube）リンクを追加

### ピンポイント天気で芝しごと（`/portal/spray/`） v1.1.3（2026-09）

- サブタイトルの下に **【公式解説】** リンクを追加（【公式解説】【新しい解説】【▶解説動画】の並び）

### ピンポイント天気で芝しごと（`/portal/spray/`） v1.1.2（2026-09）

- サブタイトルの下に **🆕 新しい解説**（ブログ）・ **▶ 解説動画**（YouTube）リンクを追加

### 病害リスク予報（`/portal/risk/`） v2.2.3（2026-09）

- リード文の下に **【公式解説】** リンクを追加（【公式解説】【新しい解説】【▶解説動画】の並び）

### 病害リスク予報（`/portal/risk/`） v2.2.2（2026-09）

- リード文の下に **🆕 新しい解説**（ブログ）・ **▶ 解説動画**（YouTube）リンクを追加

### 楽RAC農薬ローテ（`/portal/rac/`） v1.2.0（2026-09）

- リード文の下に **公式解説** リンクを追加（公式解説｜新しい解説｜解説動画の並び）
